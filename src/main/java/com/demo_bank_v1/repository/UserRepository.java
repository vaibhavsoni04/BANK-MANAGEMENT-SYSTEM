...
public interface UserRepository  extends CrudRepository<User, Integer> {
    ...
    @Modifying
    @Query(value = "INSERT INTO users (first_name, last_name, email, password, token, created_at, code) VALUES" +
            "(:first_name, :last_name, :email, :password, :token, :created_at, :code)", nativeQuery = true )
    @Transactional
