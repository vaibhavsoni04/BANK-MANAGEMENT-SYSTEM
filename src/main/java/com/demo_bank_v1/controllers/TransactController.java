...
public class TransactController {
    ...
    public String deposit(@RequestParam("deposit_amount")String depositAmount,
        ...
        if(!pattern.matcher(depositAmount).matches()){
            redirectAttributes.addFlashAttribute("error", "Only numbers are acceptable");
            return "redirect:/app/dashboard";
        }
        ...
        if(depositAmountValue < 0){
            redirectAttributes.addFlashAttribute("error", "Deposit Amount Cannot Be of Negative Value");
            return "redirect:/app/dashboard";
        }
    ...
    public String transfer(@RequestParam("transfer_from") String transfer_from,
        ...
        if(!pattern.matcher(transfer_amount).matches()){
            redirectAttributes.addFlashAttribute("error", "Only numbers are acceptable");
            return "redirect:/app/dashboard";
        }
        ...
        if(transferAmount < 0){
            errorMessage = "Cannot Transfer an amount of Negative value, please enter a value greater than 0 (Zero) ";
            redirectAttributes.addFlashAttribute("error", errorMessage);
            return "redirect:/app/dashboard";
        }
    ...
    public String withdraw(@RequestParam("withdrawal_amount")String withdrawalAmount,
        ...
        if(!pattern.matcher(withdrawalAmount).matches()){
            redirectAttributes.addFlashAttribute("error", "Only numbers are acceptable");
            return "redirect:/app/dashboard";
        }
        ...
        if (withdrawal_amount < 0){
            errorMessage = "Withdrawal Amount Cannot be of Negative value, please enter a value greater than 0 (Zero)";
            redirectAttributes.addFlashAttribute("error", errorMessage);
            return "redirect:/app/dashboard";
        }
    ...
    public String payment(@RequestParam("beneficiary")String beneficiary,
        ...
        if(!pattern.matcher(payment_amount).matches()){
            redirectAttributes.addFlashAttribute("error", "Only numbers are acceptable");
            return "redirect:/app/dashboard";
        }
        ...
        if(paymentAmount < 0){
            errorMessage = "Payment Amount Cannot be of Negative value, please enter a value greater than 0 (Zero) ";
            redirectAttributes.addFlashAttribute("error", errorMessage);
            return "redirect:/app/dashboard";
        }
